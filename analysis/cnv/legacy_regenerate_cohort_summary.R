...
#   Script: analysis/cnv/legacy_regenerate_cohort_summary.R
#   Methodology: historical uncentred MP/CNV summary only
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Reads superseded nMP=13 UCell/MP inputs.
####################
