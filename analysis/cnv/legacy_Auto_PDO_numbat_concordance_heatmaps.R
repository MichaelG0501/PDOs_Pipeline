...
#   Script: analysis/cnv/legacy_Auto_PDO_numbat_concordance_heatmaps.R
#   Methodology: historical method only; see analysis/ANALYSIS_MAP.md
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Superseded exploratory or uncentred workflow; do not use its
#     outputs as current centred-MP/state inputs.
####################
...
out_dir <- file.path(PDO_LIVE_OUTS, "Auto_PDO_numbat")
