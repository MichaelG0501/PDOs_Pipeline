...
#   Script: analysis/cnv/legacy_Auto_PDO_numbat_subclone_mp_heatmap.R
...
out_dir <- file.path(PDO_LIVE_OUTS, if (use_conservative_clones) "Auto_PDO_numbat_subclone_mp_conservative" else "Auto_PDO_numbat_subclone_mp")
####################
