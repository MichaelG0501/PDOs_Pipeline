...
#   Script: analysis/cell_states/legacy_Auto_scATLAS_four_marker_specificity.R
#   Methodology: historical marker-panel method only
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Uses the superseded pre-centred marker/state panel.
####################
