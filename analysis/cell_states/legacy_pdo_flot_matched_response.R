...
#   Script: analysis/cell_states/legacy_pdo_flot_matched_response.R
...
####################
####################
# Manuscript status override (31 Jul 2026): legacy.
# Do not use this nMP13/Auto_PDO_final_states workflow for current figures.
# The active current-centred successor is:
# analysis/cell_states/centred_refined_pdo_flot_matched_response.R
####################
# Analysis registry:
