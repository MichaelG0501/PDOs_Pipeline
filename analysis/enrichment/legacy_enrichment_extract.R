...
#   Status: legacy; scRef-specific temporary extraction, no PDO downstream use
#   Script: analysis/enrichment/legacy_enrichment_extract.R
#   Methodology: historical extraction only
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Reads an external scRef enrichment object and is not a current
#     centred PDO enrichment workflow.
####################
